...
import com.inha.sellstarter.domain.usecase.chatbot.ChatbotMessageUseCase
import com.inha.sellstarter.domain.usecase.chatbot.ChatbotUseCases
import com.inha.sellstarter.domain.usecase.chatbot.EndChatUseCase
import com.inha.sellstarter.domain.usecase.chatbot.StartChatUseCase
import com.inha.sellstarter.domain.usecase.dataanalysis.DataAnalysisUseCases
import com.inha.sellstarter.domain.usecase.dataanalysis.LoadDataReportUseCase
import com.inha.sellstarter.domain.usecase.dataanalysis.LoadInventoryFlowGraphUseCase
import com.inha.sellstarter.domain.usecase.home.HomeUseCases
import com.inha.sellstarter.domain.usecase.home.LoadHomeDashboardUseCase
import com.inha.sellstarter.domain.usecase.home.LoadWeeklySalesUseCase
import com.inha.sellstarter.domain.usecase.home.LoadYearlySalesUseCase
import com.inha.sellstarter.domain.usecase.inventory.InventoryUseCases
import com.inha.sellstarter.domain.usecase.inventory.LoadInventoryDetailUseCase
import com.inha.sellstarter.domain.usecase.inventory.LoadInventoryListUseCase
import com.inha.sellstarter.domain.usecase.inventory.RegisterInventoryItemUseCase
import com.inha.sellstarter.domain.usecase.inventory.SearchInventoriesUseCase
import com.inha.sellstarter.domain.usecase.inventory.UpdateInventoryCountUseCase
import com.inha.sellstarter.domain.usecase.mypage.LoadUserDetailUseCase
import com.inha.sellstarter.domain.usecase.mypage.MyPageUseCases
import com.inha.sellstarter.domain.usecase.mypage.RegisterStoreApiKeyUseCase
import com.inha.sellstarter.domain.usecase.mypage.RemoveStoreApiKeyUseCase
import com.inha.sellstarter.domain.usecase.mypage.UpdateStoreApiKeyUseCase
import com.inha.sellstarter.domain.usecase.order.CancelOrderUseCase
import com.inha.sellstarter.domain.usecase.order.CheckPickingAvailableUseCase
...
import com.inha.sellstarter.domain.usecase.order.LoadCompletedPickingListUseCase
import com.inha.sellstarter.domain.usecase.order.LoadOrderConfirmListUseCase
import com.inha.sellstarter.domain.usecase.order.LoadOrderConfirmationDetailUseCase
import com.inha.sellstarter.domain.usecase.order.OrderUseCases
...
object UseCaseModule {
    @Provides
    @Singleton
    fun provideMyPageUseCases(myPageRepository: MyPageRepository): MyPageUseCases {
    ...
    @Provides
    @Singleton
    fun provideChatbotUseCases(chatbotRepository: ChatbotRepository): ChatbotUseCases {
    ...
    @Provides
    @Singleton
    fun provideInventoryUseCase(inventoryRepository: InventoryRepository): InventoryUseCases {
    ...
    @Provides
    @Singleton
    fun provideOrderUseCase(orderRepository: OrderRepository): OrderUseCases {
        return OrderUseCases(
            loadOrderConfirmListUseCase = LoadOrderConfirmListUseCase(orderRepository),
            loadOrderConfirmationDetailUseCase =
                LoadOrderConfirmationDetailUseCase(
                    orderRepository,
                ),
    ...
    @Provides
    @Singleton
    fun provideDataAnalysisUseCase(dataAnalysisRepository: DataAnalysisRepository): DataAnalysisUseCases {
    ...
    @Provides
    @Singleton
    fun provideHomeUseCase(homeRepository: HomeRepository): HomeUseCases {
        return HomeUseCases(
