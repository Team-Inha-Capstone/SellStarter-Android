    ...
    Column(modifier = modifier) {
        BasicTextField(
            ...
            modifier = Modifier
                ...
                .border(
                    width = 1.dp,
                    color = if (isAvailable) Blue200
                    else if (isError) Red200 else Grey100,
        ...
        Text(
            text = if (isAvailable) availableDescription else if (isError) errorDescription else "",
            modifier = Modifier.padding(4.dp),
            color = if (isAvailable) Blue200 else if (isError) Red200 else Grey100,
        )
    }
}
