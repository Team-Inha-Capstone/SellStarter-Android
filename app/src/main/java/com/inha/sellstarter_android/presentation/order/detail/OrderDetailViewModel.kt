...
class OrderDetailViewModel @Inject constructor(
    ...
    fun loadOrderDetail(orderId: String) {
        viewModelScope.launch {
            _orderDetailState.value = safeApiCall(
    ...
    fun completeOrderPickings(orderId: String) {
        viewModelScope.launch {
            _completePickingsState.value = safeApiCall(
    ...
    fun completeSinglePicking(orderId: String, request: OrderInventoryPickingRequestDto) {
        viewModelScope.launch {
            _singlePickingState.value = safeApiCall(
    ...
    fun cancelOrder(orderId: String) {
        viewModelScope.launch {
            _cancelState.value = safeApiCall(
