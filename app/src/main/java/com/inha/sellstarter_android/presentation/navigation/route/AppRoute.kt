package com.inha.sellstarter_android.presentation.navigation.route
...
sealed class AppRoute(val route: String) {
    ...
    data class InventoryScan(val orderId: String, val barcodeId: String) :
        ...
        companion object {
            ...
            const val BARCODE_ID = "barcodeId"
            fun createRoute(orderId: String, barcodeId: String) =
    ...
    data class OrderDetail(val orderId: String, val isFromCompleted: Boolean) :
        ...
        companion object {
            ...
            fun createRoute(orderId: String, isFromCompleted: Boolean) =
